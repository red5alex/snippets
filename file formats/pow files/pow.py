...
class PowFile:
    ...
    def saveTo(self, filename):
        ...
        for ts in self.timeSeries:
            ...
            outfile.writelines("! " + str(ts.name)+"\n")
            outfile.writelines("! [type="+str(ts.type) +
                               ";option="+str(ts.option) +
                               ";timeunit="+str(ts.timeunit) +
                               ";unitclass="+str(ts.unitclass) +
                               ";userunit="+str(ts.userunit) + "]\n")
